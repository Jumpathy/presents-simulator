return function(gui)
	...
	scale.gui = gui;
	scale.healthBar = gui:WaitForChild("Status"):WaitForChild("Health");
	scale.label = gui:WaitForChild("Label");

	scale.health = {
		gui.Parent:WaitForChild("Values"):WaitForChild("Health"),
		gui.Parent:WaitForChild("Values"):WaitForChild("MaxHealth"),
	}

	scale.format = function(int)
		return format.FormatStandard(int);
	end
	...
	scale.getText = function()
		return(scale.format(scale.health[1].Value) .. " / " .. scale.format(scale.health[2].Value));
	end
