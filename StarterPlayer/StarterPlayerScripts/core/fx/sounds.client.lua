...
local sounds,stored,selected = {
	...
	["Area5"] = { -- Volcano area
		"rbxassetid://9045937895", -- Volcanoes On Mars
		"rbxassetid://1837580579", -- Master of time
		"rbxassetid://1847008221", -- Volcanic Eruption
		"rbxassetid://9043088672", -- Lava
	},
	["Area6"] = { -- Beach
	...
	["Area7"] = { -- Frost
		"rbxassetid://1836879573", --- Frost
		"rbxassetid://156001076", -- Winter frost
		"rbxassetid://1835629568", -- Arctic
		"rbxassetid://1847389503", -- Arctic lights a
		"rbxassetid://1842737900" -- Arctic winter
	}
},{},"";
	...
	if(last == key and inside) then
		...
		ambient.Ended:Connect(function()
			if(last == key and inside) then
				...
				local c = 0;
				repeat
					aKey = math.random(1,#array);
					c += 100;
				until(aKey ~= pointers[region] or c>=100);
